 ...
 * __master__ - (_2015-09-02_)
    ...
    - Added ability to persist streaming to DLNA device even if the sink is "silent" (no playback streams)
    - Default sample rate set to 48kHz
